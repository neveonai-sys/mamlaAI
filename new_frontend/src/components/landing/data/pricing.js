...
export const LAWYER_PLANS = [
  ...
  {
    name: 'Student',
    subtitle: 'For law students & interns',
    price: '₹699',
    period: '/month',
    cta: 'Join as Student',
    recommended: false,
    items: ['50 Legal Chat queries', '15 Doc Analysis sessions', '30 AI Drafts', '20 Drafting actions', '10 AI Suggestions', '3 Case Companion sessions', 'eCourts CNR Lookup (60/month)', 'Order Downloads (15/month)', 'College name verification'],
  },
  {
    name: 'Basic',
