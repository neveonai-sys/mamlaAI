...
# Check if port 3000 is still occupied after cleanup
if is_port_in_use 3000; then
    echo "Error: Port 3000 is still in use after stopping existing services. Please free the port and try again."
    exit 1
fi
